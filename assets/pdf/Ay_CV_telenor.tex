...
\cvitem{Citizenship}{Turkish (Permanent Resident in Norway)}
...
\cvitem{}{Behavioral Economics, Experimental Economics, Self and Social Image, Information Preferences}
%----------------------------------------------------------------------------------------
%	Employment
%----------------------------------------------------------------------------------------
...
\cvitem{Status:}{\textit{Working paper is in progress - Data collection is completed in August 2019}}
...
\cvitem{Status:}{\textit{Pilot data collection is completed in January 2020- Data collection will be completed by December 2020. }}
...
\cvitem{Status:}{\textit{Working paper is in progress - Data collection is completed in October 2019}}
...
\cvitem{Pipeline}{\textbf{The effects of Information from Previous Counterparts in Collaboration - joint with Louis Putterman (Brown University) and Kenju Kamei (Durham University)}}
\cvitem{}{\textit{In this project we investigate People's willingnes to transmit information about their previous counterpart and how much this information can affect collaboration in group settings.  }}


\cvitem{Pipeline}{\textbf{Preferences on the Timing of Information - joint with Marta Serra Garcia (University of California San Diego)}}
\cvitem{}{\textit{In this project we aim to investigate people's choice of timing for receiving an unpleasant information about the consequences of a decision. This information could be about the consequences of a decision that may increase one's own benefit while causing negative outcome for others or for oneself like ethical questions when consuming a product or privacy violations while enjoying a service subscription. }}

\section{Presentations at Conferences and Seminars}
\cvitem{October 2020}{BBE Workshop at Humboldt University}
...
\section{Languages}
\cvitem{Languages}{Turkish (native), English (fluent), Norwegian (intermediate)}
\section{Software and Data Skills}
\cvitem{Software and Programming Languages}{ Github (Version Control), JavaScript (Web Apps), Latex, Mathematica (Analytical Models), oTree (Experiment Programming and Data Collection with Heroku), Python (Data Analysis, Django), R (Data Analysis), Stata(Data Analysis), Subversion (Version Control), zTree (Experiment Programming)}
