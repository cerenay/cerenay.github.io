...
\firstname{Ceren} % Your first name
...
\cvitem{}{\textit{The goal of this collaboration is to bring together scholars from around the globe to examine psychological factors underlying the attitudes and behavioral intentions related to Covid-19. To date, data from over 44.000 citizens in 67 countries are collected.} \href{https://icsmp-covid19.netlify.app}{\color{blue}Project website}}
